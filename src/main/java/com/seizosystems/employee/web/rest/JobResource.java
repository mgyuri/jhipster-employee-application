...
import com.seizosystems.employee.domain.Job;
import com.seizosystems.employee.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.seizosystems.employee.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
